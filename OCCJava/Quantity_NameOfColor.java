 ...
 */
public enum Quantity_NameOfColor {
  Quantity_NOC_BLACK,
  ...
  public static Quantity_NameOfColor swigToEnum(int swigValue) {
    Quantity_NameOfColor[] swigValues = Quantity_NameOfColor.class.getEnumConstants();
    if (swigValue < swigValues.length && swigValue >= 0 && swigValues[swigValue].swigValue == swigValue)
      return swigValues[swigValue];
    for (Quantity_NameOfColor swigEnum : swigValues)
      if (swigEnum.swigValue == swigValue)
        return swigEnum;
    throw new IllegalArgumentException("No enum " + Quantity_NameOfColor.class + " with value " + swigValue);
  }

  @SuppressWarnings("unused")
  private Quantity_NameOfColor() {
    this.swigValue = SwigNext.next++;
  }

  @SuppressWarnings("unused")
  private Quantity_NameOfColor(int swigValue) {
    this.swigValue = swigValue;
    SwigNext.next = swigValue+1;
  }

  @SuppressWarnings("unused")
  private Quantity_NameOfColor(Quantity_NameOfColor swigEnum) {
